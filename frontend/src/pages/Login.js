        ...
        <div className='bg-white p-5 w-full max-w-sm mx-auto'>
          ...
          <form className='pt-2 flex flex-col gap-2' onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <Link to={'/forgot-password'} className='block w-fit ml-auto hover:underline hover:text-black mt-4'>
                Forgot password ?
              </Link>
          ...
          <p className='my-5'>Don't have account ? <Link to={"/sign-up"} className='text-blue-600 hover:text-blue-900 hover:underline'>Sign up</Link></p>
