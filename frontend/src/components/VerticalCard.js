...
const VerticalCard = ({ loading, data = [] }) => {
    ...
    return (
        <div className='grid grid-cols-[repeat(auto-fit,minmax(260px,300px))] justify-center md:justify-between md:gap-4 overflow-x-scroll scrollbar-none scroll-smooth transition-all'>
                            ...
                            <div className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] bg-white rounded-sm shadow'>
                                ...
                                <div className='p-4 grid gap-3'>
                                    ...
                                    <div className='flex gap-2'>
                                        <p className='text-blue-950 font-medium p-1 animate-pulse rounded-full bg-slate-200 w-full py-2'></p>
